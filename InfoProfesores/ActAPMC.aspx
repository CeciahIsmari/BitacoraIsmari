<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActAPMC.aspx.cs" Inherits="InfoProfesores.ActAPMC" %>
...
<body>
   <form id="form1" runat="server">
        ...
        <div style="margin-left:400px;">
            <asp:Button ID="btnRegis" runat="server" Text="Actualizar" class="btn btn-primary" OnClick="btnRegis_Click" />
            <asp:TextBox ID="txtIdAPMC" runat="server" Visible="False"></asp:TextBox>
