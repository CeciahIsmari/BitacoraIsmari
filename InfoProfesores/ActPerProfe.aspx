<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActPerProfe.aspx.cs" Inherits="InfoProfesores.ActPerProfe" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin-left:400px;">
            ...
            <asp:TextBox ID="txtIdPP" runat="server" Visible="False"></asp:TextBox>
        </div>
    </form>
</body>
</html>
