<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertProfe.aspx.cs" Inherits="InfoProfesores.InsertProfe" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-group" style="width:700px; margin-left:400px; margin-top:50px;">
           ...
           <div class="col">
            ...
            <div class="col">
                ...
                <asp:TextBox ID="txtregEmp" runat="server" class="form-control"></asp:TextBox>
            </div>
            </div>
        </div>
        </div>
        ...
        <div class="row">
        <div class="col">
            <asp:Button ID="btnRegi" runat="server" Text="Registrar Profesor" class="btn btn-primary" Click="btnRegi_Click" OnClick="btnRegi_Click" />
        </div>
        <div class="col">
            <asp:Button ID="btnEdProf" runat="server" Text="Editar Profesor" class="btn btn-primary" OnClick="btnEdProf_Click"/>
        </div>
        </div>
        </div>
    </form>
